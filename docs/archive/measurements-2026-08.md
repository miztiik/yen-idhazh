...
**Every section on this page is cited by a live page.** That is the admission
rule: a section stays while something still links it, and goes when nothing does.
