...
[../architecture/publishing/same-story.md](../architecture/publishing/same-story.md).
...
- [../architecture/publishing/same-story.md](../architecture/publishing/same-story.md) - what the line decides, how it moves, and what the current marks say about it.
