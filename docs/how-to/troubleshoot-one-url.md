...
| Summary `model_timed_out` | The server took the request and did not answer inside `models.summarize.request.request_timeout_minutes`. It was serving; it was writing more tokens than the clock admits. Read the output budget, not the process. |
