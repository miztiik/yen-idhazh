...
**The row comes off the shard that did the work.** A worker validates 114 cells
...
two payloads carry: on the committed fixture day, 40 of the 114 columns against
71. The 32 columns in the gap are the ones nothing downstream could ever recover
