...
class FeedHealthRow(Contract):
    ...
    __changelog__: ClassVar[tuple[ChangelogEntry, ...]] = (
        ChangelogEntry(
            ...
            change="endpoint_key, robots_outcome, robots_checked_at and robots_status added.",
            why="The record said what a feed answered and not which address was asked.",
        ),
        ChangelogEntry(
            version="2026-08-23T12:00",
            change="outcome gains `skipped`, for a run that held a quarantined feed back.",
            why="A quarantine that writes nothing can never lift itself.",
        ),
        ChangelogEntry(
            version="2026-08-23",
            change="Initial shape: the feed, the run, the outcome and what it yielded.",
            why="A feed can go quiet for a week before anybody notices.",
        ),
    )
