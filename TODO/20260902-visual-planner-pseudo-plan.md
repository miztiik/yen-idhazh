...
**C16 to C24 correct this document rather than the proposal, and were verified against the tree on 2026-09-05.** They are in the same numbered sequence deliberately: a reader checking a claim should not have to know which document made it. Seven of the nine make a row cheaper or already-done; two (C22, C23) make a row more expensive, because a tuple edit turns out to be a persisted-contract change. **The pattern is the one section 12.15 already named** - a claim about the current tree rots in days on this repository, and none of these was older than a fortnight.
