...
| B8 | [test_reference_dataset.py](../backend/tests/test_reference_dataset.py), [backend/tests/contracts/](../backend/tests/contracts/) | Extend the existing tests. Use bounded fixtures and temporary output roots; never make pytest walk the real collected articles. |
