...
| [20260905-11-two-call-planner-plan.md](20260905-11-two-call-planner-plan.md) | 11 | 6 | 5 | 0 |
...
| --- | --- | --- | --- | --- |
| #3d | 11 | C3 | The instrument says where every re-read token went | p11-3d |
...
| #3c | 11 | C4 | Own the prompt bytes | 3d is IN-FLIGHT |
