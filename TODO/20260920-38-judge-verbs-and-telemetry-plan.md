...
| Row #24's report | `idhazh.ledger` pulls three of the content-similarity judge's contracts into `idhazh.council.tenancy`'s closure. Not a judge's code, but a judge's published shape inside the venue's closure. Row #18 moved those stores and did not cut the import; it stays open. |
...
| 21a | The council asks every tenant what it is behind on | 15a, 17, 24 | S | DONE | - | - | worker |
