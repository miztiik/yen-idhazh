...
| 10 | Did another tenant take the processor | 5, 8, 9 | C | DONE | p37r10 | #1010 | worker |
| 11 | Is the kernel taking the model's weights back | 5, 8, 9 | C | DONE | p37r11 | #1008 | worker |
| 12 | What one article costs the machine | 9 | C | DONE | p37r12 | #1001 | worker |
| 13 | Two panels leave the page | 9 | C | DONE | p37r13 | #986 | worker |
...
| 19 | Which prompts get re-read, and how fast | 9 | C | DONE | p37r19 | #1002 | worker |
| 20 | What is holding the runner's memory | 5, 9 | C | DONE | p37r20 | #1003 | worker |
...
| 17 | Every published column names its reader | 5, 10, 11, 12, 13, 14, 15, 16, 19, 20, 21, 22 | D | IN REVIEW | p37r17 | #1017 | worker |
...
| 5 | Row #22's `span` prop goes; its naming attaches to the figure this row leads with | 2026-09-21, merging Row #22 in. That prop carried the window's low-to-high **peak** memory, which is the mark decision 1 takes off the page, and its only source went with the window grain. The days a setting moved on are still named - under the kernel track, because the board is one run and the caveat is now about a reading the person remembers from an earlier day rather than about two ends of one track. `windowDays` stays: it bounds which days the page looked at |
