...
| 3 | **The three dated records keep their references.** `data-growth.md` is pinned to `76c2d27c` and `test-execution-audit.md` to `3b425be8`; both describe a `surveyDigest` that had already been deleted before this plan was written. Editing a frozen record to match today's tree destroys the only thing it is for | `CLAUDE.md` section 5 |
