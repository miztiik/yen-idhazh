...
- [`docs/architecture/publishing/same-story.md`](../docs/architecture/publishing/same-story.md) - the merge line, its rationale and the alternatives already rejected.
