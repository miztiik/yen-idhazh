...
| Blocked by | **Plan 41, open as PR #1036, already edits `backend/utilities/model_refs.py`** - the file row 1 rewrites. Section 1e is the decision rule that keeps this from deadlocking. |
...
- [`20260921-41-lane-a-model-file-plan.md`](20260921-41-lane-a-model-file-plan.md) - open as PR #1036; section 1e is the only coupling.
