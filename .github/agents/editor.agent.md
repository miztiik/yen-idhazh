...
- Before answering, run the bootstrap ritual in [`docs/agents/bootstrap.md`](../../docs/agents/bootstrap.md) and honour the guardrails in [`CLAUDE.md`](../../CLAUDE.md) section 1.
