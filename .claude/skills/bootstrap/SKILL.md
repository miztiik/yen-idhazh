...
3. In your first paragraph back to the user, name the guardrails and docs that are load-bearing for the answer (the final step of the ritual).
...
- [`CLAUDE.md`](../../../CLAUDE.md) - the engineering contract; section 1 is the guardrails every persona must honour.
